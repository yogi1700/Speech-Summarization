...
sound = AudioSegment.from_wav("/home/yogi/Downloads/Internship/yogendra/TimJackson_2010G.wav")
...
silence_ranges = detect_silence(sound, min_silence_len = 1000, silence_thresh = -36, seek_step = 5)
chunks = []
temp3 = 0
...
for i, chunk in enumerate(chunks):
    chunk.export("/home/yogi/Downloads/Internship/yogendra/UF2/chunk{0}.wav".format(i), format="wav")
